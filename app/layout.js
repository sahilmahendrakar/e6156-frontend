  ...
  return (
    <html lang="en">
      ...
      <div class="flex items-center flex-shrink-0 text-white mr-6">
        <span class="font-semibold text-xl tracking-tight">Book Buddy</span>
      </div>
      ...
      <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div class="text-sm lg:flex-grow">
          <Link href="/" class="block mt-4 lg:inline-block lg:mt-0 text-white-200 hover:text-white mr-4">
            Home
          </Link>
